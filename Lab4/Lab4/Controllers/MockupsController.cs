...
namespace Lab4.Controllers
{
    public class MockupsController : Controller
    {
        ...
        [HttpPost]
        public IActionResult SignUp(Authorization a)
        {
        ...
        [HttpPost]
        public IActionResult SignUp2(Authorization a)
        {
        ...
        [HttpPost]
        public IActionResult Reset2(Authorization a, string myTextbox)
        {
        ...
        [HttpPost]
        public IActionResult Reset3(Authorization a)
        {
