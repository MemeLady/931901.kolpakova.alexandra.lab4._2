...
namespace Lab4.Models
{
    ...
    public class IdentityMap
    {
        ...
        private Dictionary<string, Authorization> accounts = new Dictionary<string, Authorization>();
        private IdentityMap() { }
        ...
        public static void AddAction(Authorization account, string email)
        {
            Instance.accounts.Add(email, account);
        }
        public static Dictionary<string, Authorization> Get()
        {
